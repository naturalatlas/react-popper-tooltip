...
function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactPopper.Manager, null, React.createElement(reactPopper.Reference, null, function (_ref3) {
      var ref = _ref3.ref;
      return children({
        getTriggerProps: _this2.getTriggerProps,
        triggerRef: ref
      });
    }), this._getState() && (usePortal ? reactDom.createPortal(popper, portalContainer) : popper));
  };
